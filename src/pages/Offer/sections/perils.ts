...
export const HOUSE_PERILS = [
  {
    ...
    icons: [
      ...
      },
      {
        key: 6,
        title: 'Skadedjur',
        icon: '/new-member-assets/offering/skadedjur.svg',
        iconGrey: '/new-member-assets/offering/skadedjur-grey.svg',
        expandableText:
          'Alla djur är inte snälla djur. Oroa dig inte, om råttor, möss och andra vilda djur har tagits sig in i ditt hem eller om ditt hem har skadats av träinsekter så ersätter Hedvig både sanering och reperation av ditt hem.',
      },
      {
        key: 7,
        title: 'Ombyggnad',
        icon: '/new-member-assets/offering/underkonstruktion.svg',
        iconGrey: '/new-member-assets/offering/underkonstruktion-grey.svg',
        expandableText:
          'När ditt hem är under om/tillbyggnad så är den självklart försäkrad hos oss. Hedvig täcker också arbetsbodar, material och verktyg inköpta till om/tillbyggnaden.',
      },
    ],
  },
  {
