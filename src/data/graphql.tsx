...
export type AdditionalPaymentsDetailsResponse = AdditionalPaymentsDetailsResponseFinished | AdditionalPaymentsDetailsResponseAction;
...
export type Agreement = SwedishApartmentAgreement | SwedishHouseAgreement | NorwegianHomeContentAgreement | NorwegianTravelAgreement;
...
export type CompleteQuoteDetails = CompleteApartmentQuoteDetails | CompleteHouseQuoteDetails | UnknownQuoteDetails;
...
export type EmbarkAction = EmbarkNumberActionSet | EmbarkTextActionSet | EmbarkTextAction | EmbarkSelectAction | EmbarkNumberAction | EmbarkMultiAction;

export type EmbarkActionCore = {
  component: Scalars['String'],
};

export type EmbarkApi = EmbarkApiPersonalInformation | EmbarkApiHouseInformation | EmbarkApiCreateQuote | EmbarkApiGraphQlQuery | EmbarkApiGraphQlMutation;
...
export type EmbarkApiGraphQlVariable = EmbarkApiGraphQlSingleVariable | EmbarkApiGraphQlGeneratedVariable | EmbarkApiGraphQlMultiActionVariable;
...
export type EmbarkExpression = EmbarkExpressionUnary | EmbarkExpressionBinary | EmbarkExpressionMultiple;
...
export type EmbarkMultiActionComponent = EmbarkNumberAction | EmbarkDropdownAction | EmbarkSwitchAction;
...
export type EmbarkRedirect = EmbarkRedirectUnaryExpression | EmbarkRedirectBinaryExpression | EmbarkRedirectMultipleExpressions;
...
export type ImportantMessageUpdateManyWithoutLanguageInput = {
  ...
  update?: Maybe<Array<ImportantMessageUpdateWithWhereUniqueWithoutLanguageInput>>,
  ...
  upsert?: Maybe<Array<ImportantMessageUpsertWithWhereUniqueWithoutLanguageInput>>,
};
...
export type Incentive = MonthlyCostDeduction | FreeMonths | NoDiscount | PercentageDiscountMonths;
...
export type KeyCreateInput = {
  ...
  keyGearItemCoverageTitle?: Maybe<KeyGearItemCoverageCreateOneWithoutTitleInput>,
  keyGearItemCoverageDescription?: Maybe<KeyGearItemCoverageCreateOneWithoutDescriptionInput>,
};
...
export type KeyUpdateInput = {
  ...
  keyGearItemCoverageTitle?: Maybe<KeyGearItemCoverageUpdateOneWithoutTitleInput>,
  keyGearItemCoverageDescription?: Maybe<KeyGearItemCoverageUpdateOneWithoutDescriptionInput>,
};
...
export type QuoteDetails = SwedishApartmentQuoteDetails | SwedishHouseQuoteDetails | NorwegianHomeContentsDetails | NorwegianTravelDetails;
...
export type Referral = ActiveReferral | InProgressReferral | AcceptedReferral | TerminatedReferral;
...
export type StartSignResponse = SwedishBankIdSession | NorwegianBankIdSession | FailedToStartSign;
...
export type TokenizationResponse = TokenizationResponseFinished | TokenizationResponseAction;
...
export type EditQuoteMutation = (
  ...
  & { editQuote: (
    { __typename?: 'CompleteQuote' }
    & Pick<CompleteQuote, 'id'>
  ) | (
    { __typename?: 'UnderwritingLimitsHit' }
    & { limits: Array<(
      { __typename?: 'UnderwritingLimit' }
      & Pick<UnderwritingLimit, 'description'>
    )> }
  ) }
);
...
export type ExternalInsuranceDataQuery = (
  { __typename?: 'Query' }
  & { externalInsuranceProvider: Maybe<(
    { __typename?: 'ExternalInsuranceProvider' }
    & { dataCollection: Array<(
      { __typename?: 'InsuranceDataCollection' }
      & Pick<InsuranceDataCollection, 'renewalDate' | 'insuranceProvider'>
      & { monthlyPremium: Maybe<(
        { __typename?: 'MonetaryAmountV2' }
        & Pick<MonetaryAmountV2, 'currency' | 'amount'>
      )> }
    )> }
  )> }
);
...
export type ExternalInsuranceDataStatusSubscription = (
  ...
  & { dataCollectionStatus: Maybe<(
    { __typename?: 'DataCollectingStatusResponse' }
    & Pick<DataCollectingStatusResponse, 'status'>
  )> }
);
...
export type MemberOfferQuery = (
  { __typename?: 'Query' }
  & { lastQuoteOfMember: (
    { __typename?: 'CompleteQuote' }
    & Pick<CompleteQuote, 'id' | 'dataCollectionId' | 'ssn' | 'email' | 'firstName' | 'lastName' | 'startDate'>
    & { currentInsurer: Maybe<(
      { __typename?: 'CurrentInsurer' }
      & Pick<CurrentInsurer, 'id' | 'displayName' | 'switchable'>
    )>, insuranceCost: (
      { __typename?: 'InsuranceCost' }
      ...
      { __typename?: 'CompleteApartmentQuoteDetails' }
      & Pick<CompleteApartmentQuoteDetails, 'street' | 'zipCode' | 'householdSize' | 'livingSpace' | 'type'>
    ) | (
      { __typename?: 'CompleteHouseQuoteDetails' }
      & Pick<CompleteHouseQuoteDetails, 'street' | 'zipCode' | 'householdSize' | 'livingSpace' | 'ancillarySpace' | 'numberOfBathrooms' | 'yearOfConstruction' | 'isSubleted'>
      & { extraBuildings: Array<(
        { __typename?: 'ExtraBuildingGarage' }
        & Pick<ExtraBuildingGarage, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingCarport' }
        & Pick<ExtraBuildingCarport, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingShed' }
        & Pick<ExtraBuildingShed, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingStorehouse' }
        & Pick<ExtraBuildingStorehouse, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingFriggebod' }
        & Pick<ExtraBuildingFriggebod, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingAttefall' }
        & Pick<ExtraBuildingAttefall, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingOuthouse' }
        & Pick<ExtraBuildingOuthouse, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingGuesthouse' }
        & Pick<ExtraBuildingGuesthouse, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingGazebo' }
        & Pick<ExtraBuildingGazebo, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingGreenhouse' }
        & Pick<ExtraBuildingGreenhouse, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingSauna' }
        & Pick<ExtraBuildingSauna, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingBarn' }
        & Pick<ExtraBuildingBarn, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingBoathouse' }
        & Pick<ExtraBuildingBoathouse, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
        { __typename?: 'ExtraBuildingOther' }
        & Pick<ExtraBuildingOther, 'area' | 'displayName' | 'hasWaterConnected'>
      )> }
    ) | { __typename?: 'UnknownQuoteDetails' } }
  ) | (
    { __typename?: 'IncompleteQuote' }
    & Pick<IncompleteQuote, 'id'>
    ...
    & { incentive: Maybe<(
      ...
      { __typename?: 'FreeMonths' }
      & Pick<FreeMonths, 'quantity'>
    ) | { __typename?: 'NoDiscount' } | (
      { __typename?: 'PercentageDiscountMonths' }
      & Pick<PercentageDiscountMonths, 'percentageDiscount'>
      & { quantityMonths: PercentageDiscountMonths['quantity'] }
    )>, owner: Maybe<(
      { __typename?: 'CampaignOwner' }
      & Pick<CampaignOwner, 'displayName'>
    )> }
  )>, member: (
    { __typename?: 'Member' }
...
export type QuoteQuery = (
  ...
  & { quote: (
    ...
    & { currentInsurer: Maybe<(
      ...
      { __typename?: 'SwedishApartmentQuoteDetails' }
      & Pick<SwedishApartmentQuoteDetails, 'street' | 'zipCode' | 'householdSize' | 'livingSpace' | 'type'>
    ) | (
      { __typename?: 'SwedishHouseQuoteDetails' }
      & Pick<SwedishHouseQuoteDetails, 'street' | 'zipCode' | 'householdSize' | 'livingSpace' | 'ancillarySpace' | 'numberOfBathrooms' | 'yearOfConstruction' | 'isSubleted'>
      & { extraBuildings: Array<(
        { __typename?: 'ExtraBuildingGarage' }
        & Pick<ExtraBuildingGarage, 'area' | 'displayName' | 'hasWaterConnected'>
      ) | (
      ...
      { __typename?: 'NorwegianHomeContentsDetails' }
      & Pick<NorwegianHomeContentsDetails, 'coInsured' | 'livingSpace' | 'street' | 'zipCode'>
      & { homeType: NorwegianHomeContentsDetails['type'] }
    ) | (
      { __typename?: 'NorwegianTravelDetails' }
      & Pick<NorwegianTravelDetails, 'coInsured'>
    ) }
  ) | (
    { __typename?: 'IncompleteQuote' }
    & Pick<IncompleteQuote, 'id'>
  ...
  & { redeemCode: (
    ...
    & { campaigns: Array<(
      ...
      & { incentive: Maybe<(
        ...
        { __typename?: 'FreeMonths' }
        & Pick<FreeMonths, 'quantity'>
      ) | { __typename?: 'NoDiscount' } | { __typename?: 'PercentageDiscountMonths' }> }
    )>, cost: (
      { __typename?: 'InsuranceCost' }
      & { monthlyGross: (
        { __typename?: 'MonetaryAmountV2' }
...
export type RedeemedCampaignsQuery = (
  { __typename?: 'Query' }
  & { redeemedCampaigns: Array<(
    { __typename?: 'Campaign' }
    & Pick<Campaign, 'code'>
...
export type RemoveStartDateMutation = (
  { __typename?: 'Mutation' }
  & { removeStartDate: (
    { __typename?: 'CompleteQuote' }
    & Pick<CompleteQuote, 'startDate'>
  ) | { __typename?: 'UnderwritingLimitsHit' } }
);
...
export type SignQuotesMutation = (
  { __typename?: 'Mutation' }
  & { signQuotes: (
    { __typename: 'SwedishBankIdSession' }
    & Pick<SwedishBankIdSession, 'autoStartToken'>
  ) | (
    { __typename: 'NorwegianBankIdSession' }
    & Pick<NorwegianBankIdSession, 'redirectUrl'>
  ) | (
    { __typename: 'FailedToStartSign' }
    & Pick<FailedToStartSign, 'errorMessage'>
  ) }
);
...
export type SignStatusQuery = (
  { __typename?: 'Query' }
  & { signStatus: Maybe<(
    { __typename?: 'SignStatus' }
    & Pick<SignStatus, 'signState'>
    & { collectStatus: Maybe<(
      { __typename?: 'CollectStatus' }
      & Pick<CollectStatus, 'status' | 'code'>
    )> }
  )> }
);
...
export type SignStatusListenerSubscription = (
  { __typename?: 'Subscription' }
  & { signStatus: Maybe<(
    { __typename?: 'SignEvent' }
    & { status: Maybe<(
...
export const EditQuoteDocument = gql`
  ...
  editQuote(input: $input) {
    ...
    `;
export type EditQuoteMutationFn = ApolloReactCommon.MutationFunction<EditQuoteMutation, EditQuoteMutationVariables>;
 ...
 * });
 */
export function useEditQuoteMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<EditQuoteMutation, EditQuoteMutationVariables>) {
        return ApolloReactHooks.useMutation<EditQuoteMutation, EditQuoteMutationVariables>(EditQuoteDocument, baseOptions);
      }
export type EditQuoteMutationHookResult = ReturnType<typeof useEditQuoteMutation>;
export type EditQuoteMutationResult = ApolloReactCommon.MutationResult<EditQuoteMutation>;
export type EditQuoteMutationOptions = ApolloReactCommon.BaseMutationOptions<EditQuoteMutation, EditQuoteMutationVariables>;
 ...
 * });
 */
export function useExternalInsuranceDataQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ExternalInsuranceDataQuery, ExternalInsuranceDataQueryVariables>) {
        return ApolloReactHooks.useQuery<ExternalInsuranceDataQuery, ExternalInsuranceDataQueryVariables>(ExternalInsuranceDataDocument, baseOptions);
      }
export function useExternalInsuranceDataLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ExternalInsuranceDataQuery, ExternalInsuranceDataQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<ExternalInsuranceDataQuery, ExternalInsuranceDataQueryVariables>(ExternalInsuranceDataDocument, baseOptions);
        }
export type ExternalInsuranceDataQueryHookResult = ReturnType<typeof useExternalInsuranceDataQuery>;
export type ExternalInsuranceDataLazyQueryHookResult = ReturnType<typeof useExternalInsuranceDataLazyQuery>;
export type ExternalInsuranceDataQueryResult = ApolloReactCommon.QueryResult<ExternalInsuranceDataQuery, ExternalInsuranceDataQueryVariables>;
 ...
 * });
 */
export function useExternalInsuranceDataStatusSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<ExternalInsuranceDataStatusSubscription, ExternalInsuranceDataStatusSubscriptionVariables>) {
        return ApolloReactHooks.useSubscription<ExternalInsuranceDataStatusSubscription, ExternalInsuranceDataStatusSubscriptionVariables>(ExternalInsuranceDataStatusDocument, baseOptions);
      }
export type ExternalInsuranceDataStatusSubscriptionHookResult = ReturnType<typeof useExternalInsuranceDataStatusSubscription>;
export type ExternalInsuranceDataStatusSubscriptionResult = ApolloReactCommon.SubscriptionResult<ExternalInsuranceDataStatusSubscription>;
 ...
 * });
 */
export function useMemberOfferQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<MemberOfferQuery, MemberOfferQueryVariables>) {
        return ApolloReactHooks.useQuery<MemberOfferQuery, MemberOfferQueryVariables>(MemberOfferDocument, baseOptions);
      }
export function useMemberOfferLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<MemberOfferQuery, MemberOfferQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<MemberOfferQuery, MemberOfferQueryVariables>(MemberOfferDocument, baseOptions);
        }
export type MemberOfferQueryHookResult = ReturnType<typeof useMemberOfferQuery>;
export type MemberOfferLazyQueryHookResult = ReturnType<typeof useMemberOfferLazyQuery>;
export type MemberOfferQueryResult = ApolloReactCommon.QueryResult<MemberOfferQuery, MemberOfferQueryVariables>;
...
export const RedeemCodeDocument = gql`
  ...
  redeemCode(code: $code) {
    ...
    `;
export type RedeemCodeMutationFn = ApolloReactCommon.MutationFunction<RedeemCodeMutation, RedeemCodeMutationVariables>;
 ...
 * });
 */
export function useRedeemCodeMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RedeemCodeMutation, RedeemCodeMutationVariables>) {
        return ApolloReactHooks.useMutation<RedeemCodeMutation, RedeemCodeMutationVariables>(RedeemCodeDocument, baseOptions);
      }
export type RedeemCodeMutationHookResult = ReturnType<typeof useRedeemCodeMutation>;
export type RedeemCodeMutationResult = ApolloReactCommon.MutationResult<RedeemCodeMutation>;
export type RedeemCodeMutationOptions = ApolloReactCommon.BaseMutationOptions<RedeemCodeMutation, RedeemCodeMutationVariables>;
 ...
 * });
 */
export function useRedeemedCampaignsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<RedeemedCampaignsQuery, RedeemedCampaignsQueryVariables>) {
        return ApolloReactHooks.useQuery<RedeemedCampaignsQuery, RedeemedCampaignsQueryVariables>(RedeemedCampaignsDocument, baseOptions);
      }
export function useRedeemedCampaignsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<RedeemedCampaignsQuery, RedeemedCampaignsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<RedeemedCampaignsQuery, RedeemedCampaignsQueryVariables>(RedeemedCampaignsDocument, baseOptions);
        }
export type RedeemedCampaignsQueryHookResult = ReturnType<typeof useRedeemedCampaignsQuery>;
export type RedeemedCampaignsLazyQueryHookResult = ReturnType<typeof useRedeemedCampaignsLazyQuery>;
export type RedeemedCampaignsQueryResult = ApolloReactCommon.QueryResult<RedeemedCampaignsQuery, RedeemedCampaignsQueryVariables>;
export const RemoveDiscountCodeDocument = gql`
  ...
  removeDiscountCode {
    ...
    `;
export type RemoveDiscountCodeMutationFn = ApolloReactCommon.MutationFunction<RemoveDiscountCodeMutation, RemoveDiscountCodeMutationVariables>;
 ...
 * });
 */
export function useRemoveDiscountCodeMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveDiscountCodeMutation, RemoveDiscountCodeMutationVariables>) {
        return ApolloReactHooks.useMutation<RemoveDiscountCodeMutation, RemoveDiscountCodeMutationVariables>(RemoveDiscountCodeDocument, baseOptions);
      }
export type RemoveDiscountCodeMutationHookResult = ReturnType<typeof useRemoveDiscountCodeMutation>;
export type RemoveDiscountCodeMutationResult = ApolloReactCommon.MutationResult<RemoveDiscountCodeMutation>;
export type RemoveDiscountCodeMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveDiscountCodeMutation, RemoveDiscountCodeMutationVariables>;
export const RemoveStartDateDocument = gql`
  ...
  removeStartDate(input: {id: $quoteId}) {
    ...
    `;
export type RemoveStartDateMutationFn = ApolloReactCommon.MutationFunction<RemoveStartDateMutation, RemoveStartDateMutationVariables>;
 ...
 * });
 */
export function useRemoveStartDateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveStartDateMutation, RemoveStartDateMutationVariables>) {
        return ApolloReactHooks.useMutation<RemoveStartDateMutation, RemoveStartDateMutationVariables>(RemoveStartDateDocument, baseOptions);
      }
export type RemoveStartDateMutationHookResult = ReturnType<typeof useRemoveStartDateMutation>;
...
export const SignQuotesDocument = gql`
  ...
  signQuotes(input: {quoteIds: $quoteIds, successUrl: $successUrl, failUrl: $failUrl}) {
    ...
    `;
export type SignQuotesMutationFn = ApolloReactCommon.MutationFunction<SignQuotesMutation, SignQuotesMutationVariables>;
 ...
 * });
 */
export function useSignQuotesMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<SignQuotesMutation, SignQuotesMutationVariables>) {
        return ApolloReactHooks.useMutation<SignQuotesMutation, SignQuotesMutationVariables>(SignQuotesDocument, baseOptions);
      }
export type SignQuotesMutationHookResult = ReturnType<typeof useSignQuotesMutation>;
export type SignQuotesMutationResult = ApolloReactCommon.MutationResult<SignQuotesMutation>;
export type SignQuotesMutationOptions = ApolloReactCommon.BaseMutationOptions<SignQuotesMutation, SignQuotesMutationVariables>;
 ...
 * });
 */
export function useSignStatusQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<SignStatusQuery, SignStatusQueryVariables>) {
        return ApolloReactHooks.useQuery<SignStatusQuery, SignStatusQueryVariables>(SignStatusDocument, baseOptions);
      }
export function useSignStatusLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SignStatusQuery, SignStatusQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<SignStatusQuery, SignStatusQueryVariables>(SignStatusDocument, baseOptions);
        }
export type SignStatusQueryHookResult = ReturnType<typeof useSignStatusQuery>;
export type SignStatusLazyQueryHookResult = ReturnType<typeof useSignStatusLazyQuery>;
export type SignStatusQueryResult = ApolloReactCommon.QueryResult<SignStatusQuery, SignStatusQueryVariables>;
 ...
 * });
 */
export function useSignStatusListenerSubscription(baseOptions?: ApolloReactHooks.SubscriptionHookOptions<SignStatusListenerSubscription, SignStatusListenerSubscriptionVariables>) {
        return ApolloReactHooks.useSubscription<SignStatusListenerSubscription, SignStatusListenerSubscriptionVariables>(SignStatusListenerDocument, baseOptions);
      }
export type SignStatusListenerSubscriptionHookResult = ReturnType<typeof useSignStatusListenerSubscription>;
export type SignStatusListenerSubscriptionResult = ApolloReactCommon.SubscriptionResult<SignStatusListenerSubscription>;
export const StartDateDocument = gql`
  ...
  editQuote(input: {id: $quoteId, startDate: $date}) {
    ...
    `;
export type StartDateMutationFn = ApolloReactCommon.MutationFunction<StartDateMutation, StartDateMutationVariables>;
 ...
 * });
 */
export function useStartDateMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<StartDateMutation, StartDateMutationVariables>) {
        return ApolloReactHooks.useMutation<StartDateMutation, StartDateMutationVariables>(StartDateDocument, baseOptions);
      }
export type StartDateMutationHookResult = ReturnType<typeof useStartDateMutation>;
export type StartDateMutationResult = ApolloReactCommon.MutationResult<StartDateMutation>;
export type StartDateMutationOptions = ApolloReactCommon.BaseMutationOptions<StartDateMutation, StartDateMutationVariables>;